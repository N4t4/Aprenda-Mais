<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#show-add-professor').click(function(){
			var url = $(this).attr("url"); 
		   	...
		   	$.ajax({
				...
				success: function (data) {
					$('#modal-adm h4').html('<span class="glyphicon glyphicon-plus"></span> Adicionar Professor');
			...
			var url = $(this).attr("url"); 
		   	...
		   	$.ajax({
				...
				success: function (data) {
					...
					$('#modal-adm h4').html('<span class="glyphicon glyphicon-pencil"></span> Editar Professor');
		...
		$('.btn-excluir').click(function(){
			...
			$('#modal-adm .modal-body').html("Deseja remover este professor dos registros?");
			$('#modal-adm').modal('show');	
