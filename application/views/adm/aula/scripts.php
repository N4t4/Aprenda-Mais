<script type="text/javascript">
	$(document).ready(function(){
		   	...
		   	$.ajax({
				...
				success: function (data) {
			    	...
			    	$("#modal-adm .confirm").unbind("click").click(function() {
			    		...
			    		var titulo = $("#aula_titulo").val();
			    		var descri = $("#aula_descricao").val();
			    		var discip = $("#aula_disciplina").val();
			    	   	...
			    	   	$.ajax({
							...
							data: {
								"aula_titulo" : titulo,
								"aula_descricao": descri,
								"aula_disciplina": discip
							}, 
							success: function (data) {
		...
		$('.btn-editar').click(function(){
			var url = $(this).attr("url"); 
		   	...
		   	$.ajax({
				...
				data: {	}, 
				success: function (data) {
					$('#modal-adm h4').html('<span class="glyphicon glyphicon-pencil"></span> Editar Aula');
		...
		$('.btn-excluir').click(function(){
			...
			$('#modal-adm h4').html('<span class="glyphicon glyphicon-trash"></span> Excluir Aula');
			$('#modal-adm #btn-no').html('<span class="glyphicon glyphicon-remove-sign"></span> Cancelar');
			...
			$('#modal-adm .modal-body').html("Deseja remover esta aula dos registros?");
			$('#modal-adm').modal('show');	
